...
<!-- Spring에서 제공해주는 태그라이브러리, prefix="form": 유효성 체크 -->
				...
				<form:form id="user-form" method="post" action="signup.do" modelAttribute="userForm">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<form:errors path="id" cssClass="text-primary"></form:errors>
						</div>
						<div class="form-group">
							<label>이름</label>							
							<form:input type="text" class="form-control" path="name" id="user-name" />
							<form:errors path="name" cssClass="text-primary"></form:errors>
						</div>
						<div class="form-group">
							<label>비밀번호</label>							
							<form:input type="password" class="form-control" path="password" id="user-password" />
							<form:errors path="password" cssClass="text-primary"></form:errors>
						</div>
						<div class="form-group">
							<label>전화번호</label>							
							<form:input type="text" class="form-control" path="tel" id="user-tel" />
							<form:errors path="tel" cssClass="text-primary"></form:errors>
						</div>
						<div class="form-group">
							<label>이메일</label>							
							<form:input type="text" class="form-control" path="email" id="user-email" />
							<form:errors path="email" cssClass="text-primary"></form:errors>
						</div>
						<div class="form-group">
							<label>나이</label>							
							<form:input type="number" class="form-control" path="age" id="user-age" />
							<form:errors path="age" cssClass="text-primary"></form:errors>
						</div>
						<div class="form-group">
							<label>생년월일</label>							
							<form:input type="date" class="form-control" path="birth" id="user-birth" />
							<form:errors path="birth" cssClass="text-primary"></form:errors>
						</div>
					</div>
